...
func (r *AWSEC2VPNGatewayRoutePropagation) AddDependencies(v ...string) *AWSEC2VPNGatewayRoutePropagation {
	if r.dependsOn == nil {
		r.dependsOn = []string{}
	}
...
func (r *AWSEC2VPNGatewayRoutePropagation) DependsOn(v ...string) []string {
	if r.dependsOn == nil {
		return []string{}
	} else {
		return r.dependsOn
