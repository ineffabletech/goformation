...
type AWSCognitoIdentityPool_CognitoIdentityProvider struct {
	...
	ServerSideTokenCheck *Boolean `json:"ServerSideTokenCheck,omitempty"`
}

// AddDependencies allows adding dependencies to the resource.
func (r *AWSCognitoIdentityPool_CognitoIdentityProvider) AddDependencies(v ...string) *AWSCognitoIdentityPool_CognitoIdentityProvider {
	if r.dependsOn == nil {
		r.dependsOn = []string{}
	}
...
func (r *AWSCognitoIdentityPool_CognitoIdentityProvider) DependsOn(v ...string) []string {
	if r.dependsOn == nil {
		return []string{}
	} else {
		return r.dependsOn
