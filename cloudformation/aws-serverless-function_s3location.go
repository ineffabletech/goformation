...
func (r *AWSServerlessFunction_S3Location) AddDependencies(v ...string) *AWSServerlessFunction_S3Location {
	if r.dependsOn == nil {
		r.dependsOn = []string{}
	}
...
func (r *AWSServerlessFunction_S3Location) DependsOn(v ...string) []string {
	if r.dependsOn == nil {
		return []string{}
	} else {
		return r.dependsOn
