...
func (r *AWSEC2VPCDHCPOptionsAssociation) AddDependencies(v ...string) *AWSEC2VPCDHCPOptionsAssociation {
	if r.dependsOn == nil {
		r.dependsOn = []string{}
	}
...
func (r *AWSEC2VPCDHCPOptionsAssociation) DependsOn(v ...string) []string {
	if r.dependsOn == nil {
		return []string{}
	} else {
		return r.dependsOn
