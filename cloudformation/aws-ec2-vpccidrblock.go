...
type AWSEC2VPCCidrBlock struct {
	...
	AmazonProvidedIpv6CidrBlock *Boolean `json:"AmazonProvidedIpv6CidrBlock,omitempty"`
...
func (r *AWSEC2VPCCidrBlock) AddDependencies(v ...string) *AWSEC2VPCCidrBlock {
	if r.dependsOn == nil {
		r.dependsOn = []string{}
	}
...
func (r *AWSEC2VPCCidrBlock) DependsOn(v ...string) []string {
	if r.dependsOn == nil {
		return []string{}
	} else {
		return r.dependsOn
