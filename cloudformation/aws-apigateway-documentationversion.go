...
func (r *AWSApiGatewayDocumentationVersion) AddDependencies(v ...string) *AWSApiGatewayDocumentationVersion {
	if r.dependsOn == nil {
		r.dependsOn = []string{}
	}
...
func (r *AWSApiGatewayDocumentationVersion) DependsOn(v ...string) []string {
	if r.dependsOn == nil {
		return []string{}
	} else {
		return r.dependsOn
