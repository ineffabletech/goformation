...
func (r *AWSEMRInstanceFleetConfig_InstanceTypeConfig) AddDependencies(v ...string) *AWSEMRInstanceFleetConfig_InstanceTypeConfig {
	if r.dependsOn == nil {
		r.dependsOn = []string{}
	}
...
func (r *AWSEMRInstanceFleetConfig_InstanceTypeConfig) DependsOn(v ...string) []string {
	if r.dependsOn == nil {
		return []string{}
	} else {
		return r.dependsOn
