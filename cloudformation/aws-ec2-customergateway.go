...
type AWSEC2CustomerGateway struct {
	...
	BgpAsn *Integer `json:"BgpAsn,omitempty"`
...
func (r *AWSEC2CustomerGateway) AddDependencies(v ...string) *AWSEC2CustomerGateway {
	if r.dependsOn == nil {
		r.dependsOn = []string{}
	}
...
func (r *AWSEC2CustomerGateway) DependsOn(v ...string) []string {
	if r.dependsOn == nil {
		return []string{}
	} else {
		return r.dependsOn
