...
func (r *AWSApiGatewayBasePathMapping) AddDependencies(v ...string) *AWSApiGatewayBasePathMapping {
	if r.dependsOn == nil {
		r.dependsOn = []string{}
	}
...
func (r *AWSApiGatewayBasePathMapping) DependsOn(v ...string) []string {
	if r.dependsOn == nil {
		return []string{}
	} else {
		return r.dependsOn
