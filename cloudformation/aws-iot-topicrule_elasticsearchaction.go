...
func (r *AWSIoTTopicRule_ElasticsearchAction) AddDependencies(v ...string) *AWSIoTTopicRule_ElasticsearchAction {
	if r.dependsOn == nil {
		r.dependsOn = []string{}
	}
...
func (r *AWSIoTTopicRule_ElasticsearchAction) DependsOn(v ...string) []string {
	if r.dependsOn == nil {
		return []string{}
	} else {
		return r.dependsOn
