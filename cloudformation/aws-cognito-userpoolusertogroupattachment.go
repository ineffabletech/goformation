...
func (r *AWSCognitoUserPoolUserToGroupAttachment) AddDependencies(v ...string) *AWSCognitoUserPoolUserToGroupAttachment {
	if r.dependsOn == nil {
		r.dependsOn = []string{}
	}
...
func (r *AWSCognitoUserPoolUserToGroupAttachment) DependsOn(v ...string) []string {
	if r.dependsOn == nil {
		return []string{}
	} else {
		return r.dependsOn
