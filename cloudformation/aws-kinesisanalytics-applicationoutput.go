...
func (r *AWSKinesisAnalyticsApplicationOutput) AddDependencies(v ...string) *AWSKinesisAnalyticsApplicationOutput {
	if r.dependsOn == nil {
		r.dependsOn = []string{}
	}
...
func (r *AWSKinesisAnalyticsApplicationOutput) DependsOn(v ...string) []string {
	if r.dependsOn == nil {
		return []string{}
	} else {
		return r.dependsOn
