...
func (r *AWSEMRInstanceGroupConfig_VolumeSpecification) AddDependencies(v ...string) *AWSEMRInstanceGroupConfig_VolumeSpecification {
	if r.dependsOn == nil {
		r.dependsOn = []string{}
	}
...
func (r *AWSEMRInstanceGroupConfig_VolumeSpecification) DependsOn(v ...string) []string {
	if r.dependsOn == nil {
		return []string{}
	} else {
		return r.dependsOn
