...
func (r *AWSElasticBeanstalkApplication) AddDependencies(v ...string) *AWSElasticBeanstalkApplication {
	if r.dependsOn == nil {
		r.dependsOn = []string{}
	}
...
func (r *AWSElasticBeanstalkApplication) DependsOn(v ...string) []string {
	if r.dependsOn == nil {
		return []string{}
	} else {
		return r.dependsOn
