...
func (r *AWSElastiCacheParameterGroup) AddDependencies(v ...string) *AWSElastiCacheParameterGroup {
	if r.dependsOn == nil {
		r.dependsOn = []string{}
	}
...
func (r *AWSElastiCacheParameterGroup) DependsOn(v ...string) []string {
	if r.dependsOn == nil {
		return []string{}
	} else {
		return r.dependsOn
