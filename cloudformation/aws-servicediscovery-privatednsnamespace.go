...
func (r *AWSServiceDiscoveryPrivateDnsNamespace) AddDependencies(v ...string) *AWSServiceDiscoveryPrivateDnsNamespace {
	if r.dependsOn == nil {
		r.dependsOn = []string{}
	}
...
func (r *AWSServiceDiscoveryPrivateDnsNamespace) DependsOn(v ...string) []string {
	if r.dependsOn == nil {
		return []string{}
	} else {
		return r.dependsOn
