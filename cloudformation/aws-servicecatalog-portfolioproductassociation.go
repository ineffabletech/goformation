...
func (r *AWSServiceCatalogPortfolioProductAssociation) AddDependencies(v ...string) *AWSServiceCatalogPortfolioProductAssociation {
	if r.dependsOn == nil {
		r.dependsOn = []string{}
	}
...
func (r *AWSServiceCatalogPortfolioProductAssociation) DependsOn(v ...string) []string {
	if r.dependsOn == nil {
		return []string{}
	} else {
		return r.dependsOn
