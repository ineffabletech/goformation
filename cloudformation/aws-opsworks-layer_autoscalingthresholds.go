...
type AWSOpsWorksLayer_AutoScalingThresholds struct {
	...
	CpuThreshold *Double `json:"CpuThreshold,omitempty"`
	...
	IgnoreMetricsTime *Integer `json:"IgnoreMetricsTime,omitempty"`
	...
	LoadThreshold *Double `json:"LoadThreshold,omitempty"`
	...
	MemoryThreshold *Double `json:"MemoryThreshold,omitempty"`
	...
	ThresholdsWaitTime *Integer `json:"ThresholdsWaitTime,omitempty"`
}

// AddDependencies allows adding dependencies to the resource.
func (r *AWSOpsWorksLayer_AutoScalingThresholds) AddDependencies(v ...string) *AWSOpsWorksLayer_AutoScalingThresholds {
	if r.dependsOn == nil {
		r.dependsOn = []string{}
	}
...
func (r *AWSOpsWorksLayer_AutoScalingThresholds) DependsOn(v ...string) []string {
	if r.dependsOn == nil {
		return []string{}
	} else {
		return r.dependsOn
