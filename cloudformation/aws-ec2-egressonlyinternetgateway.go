...
func (r *AWSEC2EgressOnlyInternetGateway) AddDependencies(v ...string) *AWSEC2EgressOnlyInternetGateway {
	if r.dependsOn == nil {
		r.dependsOn = []string{}
	}
...
func (r *AWSEC2EgressOnlyInternetGateway) DependsOn(v ...string) []string {
	if r.dependsOn == nil {
		return []string{}
	} else {
		return r.dependsOn
