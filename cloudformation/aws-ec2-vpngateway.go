...
type AWSEC2VPNGateway struct {
	...
	AmazonSideAsn *Long `json:"AmazonSideAsn,omitempty"`
...
func (r *AWSEC2VPNGateway) AddDependencies(v ...string) *AWSEC2VPNGateway {
	if r.dependsOn == nil {
		r.dependsOn = []string{}
	}
...
func (r *AWSEC2VPNGateway) DependsOn(v ...string) []string {
	if r.dependsOn == nil {
		return []string{}
	} else {
		return r.dependsOn
