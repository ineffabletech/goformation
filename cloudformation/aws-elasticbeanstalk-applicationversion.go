...
func (r *AWSElasticBeanstalkApplicationVersion) AddDependencies(v ...string) *AWSElasticBeanstalkApplicationVersion {
	if r.dependsOn == nil {
		r.dependsOn = []string{}
	}
...
func (r *AWSElasticBeanstalkApplicationVersion) DependsOn(v ...string) []string {
	if r.dependsOn == nil {
		return []string{}
	} else {
		return r.dependsOn
