...
func (r *AWSEC2SubnetRouteTableAssociation) AddDependencies(v ...string) *AWSEC2SubnetRouteTableAssociation {
	if r.dependsOn == nil {
		r.dependsOn = []string{}
	}
...
func (r *AWSEC2SubnetRouteTableAssociation) DependsOn(v ...string) []string {
	if r.dependsOn == nil {
		return []string{}
	} else {
		return r.dependsOn
