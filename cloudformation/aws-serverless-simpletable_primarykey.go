...
func (r *AWSServerlessSimpleTable_PrimaryKey) AddDependencies(v ...string) *AWSServerlessSimpleTable_PrimaryKey {
	if r.dependsOn == nil {
		r.dependsOn = []string{}
	}
...
func (r *AWSServerlessSimpleTable_PrimaryKey) DependsOn(v ...string) []string {
	if r.dependsOn == nil {
		return []string{}
	} else {
		return r.dependsOn
