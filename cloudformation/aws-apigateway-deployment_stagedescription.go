...
func (r *AWSApiGatewayDeployment_StageDescription) AddDependencies(v ...string) *AWSApiGatewayDeployment_StageDescription {
	if r.dependsOn == nil {
		r.dependsOn = []string{}
	}
...
func (r *AWSApiGatewayDeployment_StageDescription) DependsOn(v ...string) []string {
	if r.dependsOn == nil {
		return []string{}
	} else {
		return r.dependsOn
