...
func (r *AWSKinesisAnalyticsApplication) AddDependencies(v ...string) *AWSKinesisAnalyticsApplication {
	if r.dependsOn == nil {
		r.dependsOn = []string{}
	}
...
func (r *AWSKinesisAnalyticsApplication) DependsOn(v ...string) []string {
	if r.dependsOn == nil {
		return []string{}
	} else {
		return r.dependsOn
