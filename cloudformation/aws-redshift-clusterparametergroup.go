...
func (r *AWSRedshiftClusterParameterGroup) AddDependencies(v ...string) *AWSRedshiftClusterParameterGroup {
	if r.dependsOn == nil {
		r.dependsOn = []string{}
	}
...
func (r *AWSRedshiftClusterParameterGroup) DependsOn(v ...string) []string {
	if r.dependsOn == nil {
		return []string{}
	} else {
		return r.dependsOn
