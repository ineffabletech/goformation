...
type AWSKinesisFirehoseDeliveryStream_SplunkDestinationConfiguration struct {
	...
	HECAcknowledgmentTimeoutInSeconds *Integer `json:"HECAcknowledgmentTimeoutInSeconds,omitempty"`
...
func (r *AWSKinesisFirehoseDeliveryStream_SplunkDestinationConfiguration) AddDependencies(v ...string) *AWSKinesisFirehoseDeliveryStream_SplunkDestinationConfiguration {
	if r.dependsOn == nil {
		r.dependsOn = []string{}
	}
...
func (r *AWSKinesisFirehoseDeliveryStream_SplunkDestinationConfiguration) DependsOn(v ...string) []string {
	if r.dependsOn == nil {
		return []string{}
	} else {
		return r.dependsOn
