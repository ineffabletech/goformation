...
func (r *AWSServiceCatalogAcceptedPortfolioShare) AddDependencies(v ...string) *AWSServiceCatalogAcceptedPortfolioShare {
	if r.dependsOn == nil {
		r.dependsOn = []string{}
	}
...
func (r *AWSServiceCatalogAcceptedPortfolioShare) DependsOn(v ...string) []string {
	if r.dependsOn == nil {
		return []string{}
	} else {
		return r.dependsOn
