...
type AWSElasticsearchDomain_EBSOptions struct {
	...
	EBSEnabled *Boolean `json:"EBSEnabled,omitempty"`
...
func (r *AWSElasticsearchDomain_EBSOptions) AddDependencies(v ...string) *AWSElasticsearchDomain_EBSOptions {
	if r.dependsOn == nil {
		r.dependsOn = []string{}
	}
...
func (r *AWSElasticsearchDomain_EBSOptions) DependsOn(v ...string) []string {
	if r.dependsOn == nil {
		return []string{}
	} else {
		return r.dependsOn
