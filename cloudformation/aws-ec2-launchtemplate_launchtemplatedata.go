...
func (r *AWSEC2LaunchTemplate_LaunchTemplateData) AddDependencies(v ...string) *AWSEC2LaunchTemplate_LaunchTemplateData {
	if r.dependsOn == nil {
		r.dependsOn = []string{}
	}
...
func (r *AWSEC2LaunchTemplate_LaunchTemplateData) DependsOn(v ...string) []string {
	if r.dependsOn == nil {
		return []string{}
	} else {
		return r.dependsOn
