...
func (r *AWSSESReceiptRule_BounceAction) AddDependencies(v ...string) *AWSSESReceiptRule_BounceAction {
	if r.dependsOn == nil {
		r.dependsOn = []string{}
	}
...
func (r *AWSSESReceiptRule_BounceAction) DependsOn(v ...string) []string {
	if r.dependsOn == nil {
		return []string{}
	} else {
		return r.dependsOn
