...
func (r *AWSIoTThingPrincipalAttachment) AddDependencies(v ...string) *AWSIoTThingPrincipalAttachment {
	if r.dependsOn == nil {
		r.dependsOn = []string{}
	}
...
func (r *AWSIoTThingPrincipalAttachment) DependsOn(v ...string) []string {
	if r.dependsOn == nil {
		return []string{}
	} else {
		return r.dependsOn
