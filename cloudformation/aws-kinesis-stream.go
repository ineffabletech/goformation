...
type AWSKinesisStream struct {
	...
	RetentionPeriodHours *Integer `json:"RetentionPeriodHours,omitempty"`
	...
	ShardCount *Integer `json:"ShardCount,omitempty"`
...
func (r *AWSKinesisStream) AddDependencies(v ...string) *AWSKinesisStream {
	if r.dependsOn == nil {
		r.dependsOn = []string{}
	}
...
func (r *AWSKinesisStream) DependsOn(v ...string) []string {
	if r.dependsOn == nil {
		return []string{}
	} else {
		return r.dependsOn
