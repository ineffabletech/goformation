...
func (r *AWSWAFRegionalSqlInjectionMatchSet) AddDependencies(v ...string) *AWSWAFRegionalSqlInjectionMatchSet {
	if r.dependsOn == nil {
		r.dependsOn = []string{}
	}
...
func (r *AWSWAFRegionalSqlInjectionMatchSet) DependsOn(v ...string) []string {
	if r.dependsOn == nil {
		return []string{}
	} else {
		return r.dependsOn
