...
func (r *AWSAutoScalingAutoScalingGroup_MetricsCollection) AddDependencies(v ...string) *AWSAutoScalingAutoScalingGroup_MetricsCollection {
	if r.dependsOn == nil {
		r.dependsOn = []string{}
	}
...
func (r *AWSAutoScalingAutoScalingGroup_MetricsCollection) DependsOn(v ...string) []string {
	if r.dependsOn == nil {
		return []string{}
	} else {
		return r.dependsOn
