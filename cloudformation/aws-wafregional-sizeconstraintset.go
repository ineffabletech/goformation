...
func (r *AWSWAFRegionalSizeConstraintSet) AddDependencies(v ...string) *AWSWAFRegionalSizeConstraintSet {
	if r.dependsOn == nil {
		r.dependsOn = []string{}
	}
...
func (r *AWSWAFRegionalSizeConstraintSet) DependsOn(v ...string) []string {
	if r.dependsOn == nil {
		return []string{}
	} else {
		return r.dependsOn
