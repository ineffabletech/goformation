...
func (r *AWSEC2SpotFleet_InstanceIpv6Address) AddDependencies(v ...string) *AWSEC2SpotFleet_InstanceIpv6Address {
	if r.dependsOn == nil {
		r.dependsOn = []string{}
	}
...
func (r *AWSEC2SpotFleet_InstanceIpv6Address) DependsOn(v ...string) []string {
	if r.dependsOn == nil {
		return []string{}
	} else {
		return r.dependsOn
