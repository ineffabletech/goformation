...
func (r *AWSAutoScalingPlansScalingPlan_ScalingInstruction) AddDependencies(v ...string) *AWSAutoScalingPlansScalingPlan_ScalingInstruction {
	if r.dependsOn == nil {
		r.dependsOn = []string{}
	}
...
func (r *AWSAutoScalingPlansScalingPlan_ScalingInstruction) DependsOn(v ...string) []string {
	if r.dependsOn == nil {
		return []string{}
	} else {
		return r.dependsOn
