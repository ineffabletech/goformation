...
type AWSAutoScalingLaunchConfiguration_BlockDeviceMapping struct {
	...
	NoDevice *Boolean `json:"NoDevice,omitempty"`
...
func (r *AWSAutoScalingLaunchConfiguration_BlockDeviceMapping) AddDependencies(v ...string) *AWSAutoScalingLaunchConfiguration_BlockDeviceMapping {
	if r.dependsOn == nil {
		r.dependsOn = []string{}
	}
...
func (r *AWSAutoScalingLaunchConfiguration_BlockDeviceMapping) DependsOn(v ...string) []string {
	if r.dependsOn == nil {
		return []string{}
	} else {
		return r.dependsOn
