...
func (r *AWSCloudFrontStreamingDistribution) AddDependencies(v ...string) *AWSCloudFrontStreamingDistribution {
	if r.dependsOn == nil {
		r.dependsOn = []string{}
	}
...
func (r *AWSCloudFrontStreamingDistribution) DependsOn(v ...string) []string {
	if r.dependsOn == nil {
		return []string{}
	} else {
		return r.dependsOn
