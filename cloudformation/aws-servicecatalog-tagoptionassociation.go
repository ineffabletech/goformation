...
func (r *AWSServiceCatalogTagOptionAssociation) AddDependencies(v ...string) *AWSServiceCatalogTagOptionAssociation {
	if r.dependsOn == nil {
		r.dependsOn = []string{}
	}
...
func (r *AWSServiceCatalogTagOptionAssociation) DependsOn(v ...string) []string {
	if r.dependsOn == nil {
		return []string{}
	} else {
		return r.dependsOn
