...
func (r *AWSAutoScalingLaunchConfiguration_BlockDevice) AddDependencies(v ...string) *AWSAutoScalingLaunchConfiguration_BlockDevice {
	if r.dependsOn == nil {
		r.dependsOn = []string{}
	}
...
func (r *AWSAutoScalingLaunchConfiguration_BlockDevice) DependsOn(v ...string) []string {
	if r.dependsOn == nil {
		return []string{}
	} else {
		return r.dependsOn
