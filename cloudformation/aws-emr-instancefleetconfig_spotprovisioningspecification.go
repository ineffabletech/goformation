...
type AWSEMRInstanceFleetConfig_SpotProvisioningSpecification struct {
	...
	BlockDurationMinutes *Integer `json:"BlockDurationMinutes,omitempty"`
	...
	TimeoutDurationMinutes *Integer `json:"TimeoutDurationMinutes,omitempty"`
}

// AddDependencies allows adding dependencies to the resource.
func (r *AWSEMRInstanceFleetConfig_SpotProvisioningSpecification) AddDependencies(v ...string) *AWSEMRInstanceFleetConfig_SpotProvisioningSpecification {
	if r.dependsOn == nil {
		r.dependsOn = []string{}
	}
...
func (r *AWSEMRInstanceFleetConfig_SpotProvisioningSpecification) DependsOn(v ...string) []string {
	if r.dependsOn == nil {
		return []string{}
	} else {
		return r.dependsOn
