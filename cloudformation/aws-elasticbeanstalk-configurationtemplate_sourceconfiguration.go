...
func (r *AWSElasticBeanstalkConfigurationTemplate_SourceConfiguration) AddDependencies(v ...string) *AWSElasticBeanstalkConfigurationTemplate_SourceConfiguration {
	if r.dependsOn == nil {
		r.dependsOn = []string{}
	}
...
func (r *AWSElasticBeanstalkConfigurationTemplate_SourceConfiguration) DependsOn(v ...string) []string {
	if r.dependsOn == nil {
		return []string{}
	} else {
		return r.dependsOn
