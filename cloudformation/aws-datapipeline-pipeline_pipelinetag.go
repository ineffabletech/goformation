...
func (r *AWSDataPipelinePipeline_PipelineTag) AddDependencies(v ...string) *AWSDataPipelinePipeline_PipelineTag {
	if r.dependsOn == nil {
		r.dependsOn = []string{}
	}
...
func (r *AWSDataPipelinePipeline_PipelineTag) DependsOn(v ...string) []string {
	if r.dependsOn == nil {
		return []string{}
	} else {
		return r.dependsOn
