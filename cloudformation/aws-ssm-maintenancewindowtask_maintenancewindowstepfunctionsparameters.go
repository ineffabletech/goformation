...
func (r *AWSSSMMaintenanceWindowTask_MaintenanceWindowStepFunctionsParameters) AddDependencies(v ...string) *AWSSSMMaintenanceWindowTask_MaintenanceWindowStepFunctionsParameters {
	if r.dependsOn == nil {
		r.dependsOn = []string{}
	}
...
func (r *AWSSSMMaintenanceWindowTask_MaintenanceWindowStepFunctionsParameters) DependsOn(v ...string) []string {
	if r.dependsOn == nil {
		return []string{}
	} else {
		return r.dependsOn
