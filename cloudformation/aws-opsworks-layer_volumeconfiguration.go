...
type AWSOpsWorksLayer_VolumeConfiguration struct {
	...
	NumberOfDisks *Integer `json:"NumberOfDisks,omitempty"`
	...
	RaidLevel *Integer `json:"RaidLevel,omitempty"`
...
func (r *AWSOpsWorksLayer_VolumeConfiguration) AddDependencies(v ...string) *AWSOpsWorksLayer_VolumeConfiguration {
	if r.dependsOn == nil {
		r.dependsOn = []string{}
	}
...
func (r *AWSOpsWorksLayer_VolumeConfiguration) DependsOn(v ...string) []string {
	if r.dependsOn == nil {
		return []string{}
	} else {
		return r.dependsOn
