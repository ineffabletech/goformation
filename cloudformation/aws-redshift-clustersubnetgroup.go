...
func (r *AWSRedshiftClusterSubnetGroup) AddDependencies(v ...string) *AWSRedshiftClusterSubnetGroup {
	if r.dependsOn == nil {
		r.dependsOn = []string{}
	}
...
func (r *AWSRedshiftClusterSubnetGroup) DependsOn(v ...string) []string {
	if r.dependsOn == nil {
		return []string{}
	} else {
		return r.dependsOn
