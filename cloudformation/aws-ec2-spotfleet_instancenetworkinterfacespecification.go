...
func (r *AWSEC2SpotFleet_InstanceNetworkInterfaceSpecification) AddDependencies(v ...string) *AWSEC2SpotFleet_InstanceNetworkInterfaceSpecification {
	if r.dependsOn == nil {
		r.dependsOn = []string{}
	}
...
func (r *AWSEC2SpotFleet_InstanceNetworkInterfaceSpecification) DependsOn(v ...string) []string {
	if r.dependsOn == nil {
		return []string{}
	} else {
		return r.dependsOn
