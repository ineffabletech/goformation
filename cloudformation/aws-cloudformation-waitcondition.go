...
func (r *AWSCloudFormationWaitCondition) AddDependencies(v ...string) *AWSCloudFormationWaitCondition {
	if r.dependsOn == nil {
		r.dependsOn = []string{}
	}
...
func (r *AWSCloudFormationWaitCondition) DependsOn(v ...string) []string {
	if r.dependsOn == nil {
		return []string{}
	} else {
		return r.dependsOn
